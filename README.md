...
Ten progressively harder expeditions use animals featured on Forrest Galante's *Extinct or Alive* and its Shark Week specials. [Episode source](https://en.wikipedia.org/wiki/Extinct_or_Alive#Episodes). These are fictional learning missions, not accounts of verified modern animal sightings. Icons are symbolic illustrations, not species-accurate wildlife photos. Each mission includes a briefing, home-row lesson, three timed game stages, a field report, and a trophy. Every third-ish mission includes mouse actions (left click, right click, double click, scroll). A one-minute test tracks WPM, accuracy, and WPM × accuracy over time. Saved data stays in the current browser profile on this device.
